...
class ThemingControllerTest extends TestCase {
	 ...
	 */
	public function testUpdateLogoLoginScreenUploadWithInvalidImageUpload($expectedError, $expectedErrorMessage) {
		$this->request
			->expects($this->at(0))
			->method('getParam')
			->with('backgroundColor')
	 ...
	 * @dataProvider dataPhpUploadErrors
	 */
	public function testUpdateLogoUploadWithInvalidImageUpload($expectedError, $expectedErrorMessage) {
		$this->request
			->expects($this->at(0))
			->method('getParam')
			->with('backgroundColor')
